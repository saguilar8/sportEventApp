angular.module('myApp').controller('SelectEventoDeportivoController', ['$http', '$scope', '$location', '$q', '$timeout', 'NavigationService', 'EventoDeportivoService', function($http, $scope, $location, $q, $timeout, NavigationService, EventoDeportivoService) {
