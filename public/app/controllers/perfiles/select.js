angular.module('myApp').controller('SelectPerfilesController', ['$http', '$scope', '$location', '$q', '$timeout', 'NavigationService', 'PerfilesService', function($http, $scope, $location, $q, $timeout, NavigationService, PerfilesService) {
