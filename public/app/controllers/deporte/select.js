angular.module('myApp').controller('SelectDeporteController', ['$http', '$scope', '$location', '$q', '$timeout', 'NavigationService', 'DeporteService', function($http, $scope, $location, $q, $timeout, NavigationService, DeporteService) {
